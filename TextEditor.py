...
from keyboard import press_and_release,send
...
def combination(combination):
    c =ctypes.windll.LoadLibrary("user32.dll")
    pf = getattr(c, "GetKeyboardLayout")   
    #change_foreground_window_keyboard_layout(0x4090409)
...
def new_file(event = None):
    ...
    root.title(f"Текстовый редактор | Текущий файл — Untitled")
